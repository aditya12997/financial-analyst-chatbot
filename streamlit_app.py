...
SYSTEM_PROMPT = (
    ...
    'Format answers in markdown, using headers, bullet points, and tables where helpful. '
    'Never include markdown image syntax like ![alt](path) in your response, even in a table. '
    'If a chart was generated, just say so in words (for example "see the chart") '
    'and describe what it shows. The chart image itself will be displayed separately, '
